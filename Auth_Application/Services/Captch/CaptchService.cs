...
namespace Auth_Application
{
    public class CaptchService : ICaptchService
    {
        ...
        //{
        //    var encryptedCaptcha = AESencryption.DecryptString(captchToken, Key);
        ...
        //        (!captchaToken.Captcha.Equals(captchInput, StringComparison.Ordinal)))
        //        return false;
        //    else
        //        return true;
        //}
        ...
        //
        public Task<string> GenerateBase64Captcha(string captchaValue)
        {
